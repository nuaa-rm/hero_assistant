...
vector<double> initial_rot({0.0, 0.0, 0.0, 1.0});
vector<double> initial_trans_red_({0.0, 0.0, 0.0});
vector<double> initial_rot_red_({0.0, 0.0, 0.0, 1.0});
vector<double> initial_trans_blue_({0.0, 0.0, 0.0});
vector<double> initial_rot_blue_({0.0, 0.0, 0.0, 1.0});
shared_ptr<Preprocess> p_pre;
char pcd_file_name[100];
