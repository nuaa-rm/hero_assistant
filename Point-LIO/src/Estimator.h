...
extern PointCloudXYZI::Ptr feats_down_body; //只进行过下采样的点云NO.2 (new PointCloudXYZI());
extern PointCloudXYZI::Ptr feats_down_world; //feats_down_body转换坐标系后的点云NO.2 (new PointCloudXYZI());
extern PointCloudXYZI::Ptr feats_down_obstacle; //feats_down_body中障碍物的点云NO.2 (new PointCloudXYZI());
