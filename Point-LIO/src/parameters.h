...
extern std::vector<double> initial_rot;
extern std::vector<double> initial_trans_red_;
extern std::vector<double> initial_rot_red_;
extern std::vector<double> initial_trans_blue_;
extern std::vector<double> initial_rot_blue_;
extern shared_ptr<Preprocess> p_pre;
extern string priorPCDMapPath;
extern char pcd_file_name[100];
extern std::string odom_topic;
extern std::string map_frame, odom_frame;